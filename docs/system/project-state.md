...
| Migrations | `20260910112935_init`, `20260910150428_research_context_fields`, `20260915075316_research_persistence`, `20260915120000_claim_corrections`, `20260915140000_research_offerings`, `20260917130000_research_requests`, `20260917160000_research_offering_price_amount`, and `20260918090000_add_companies_opportunity_leads` applied; `prisma migrate status` clean | `soft/packages/database/prisma/migrations` |
...
- Business feature modules not yet implemented: `knowledge`, `research-records`,
  `lead-evaluator`, `company-intelligence`, `contact-discovery`,
  `outreach-drafter`, `approvals`, `jobs`. The `market-researcher`, `evidence`
  and `lead-discoverer` modules are implemented as **minimal subsets** (T-007:
  run envelope + `research_queries`; source/evidence/claim persistence; the
  evidence-backed potential-buyer shortlist — O-019). `lead-discoverer` has no
  discovery execution, scoring, or contacts yet.
